...
{
    uhos_u16 scan_interval; //<! 扫描间隔时间，取值范围: 5~10240
                            //<! Time=N * 1msec, 范围: 5msec~10.24sec
    uhos_u16 scan_window;   //<! 扫描窗口，取值范围: 5~10240
                            //<! Time=N * 1msec, 范围: 5msec~10.24sec
 ...
 * @return      uhos_ble_status_t 执行结果
 */
extern uhos_ble_status_t uhos_ble_gatts_register_destroy(destroy_func_t destroy);
